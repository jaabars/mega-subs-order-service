...
public class OrderServiceImpl implements OrderService {
    ...
    public Response saveOrder(OrderAppDto orderAppDto) {
        ...
        if (subscriberDto==null){
            ...
            Order currOrder= orderRep.findTopBySubscriberOrderByIdDesc(SubscriberMapper.INSTANCE.toSubscriber(subscriberDto));
    ...
    @Override
    public Response getOrdersByStatus(OrderStatus orderStatus) {

        Response response = Response.getResponse();
        List<OrderHistory> orderHistories = orderHistoryService.findOrderHistoriesByStatus(orderStatus);
        List<OrderDto> orderDtoList = OrderMapper.INSTANCE.toOrderDtoListFromOrderHistories(orderHistories);
        response.setObject(orderDtoList);
        return response;
    }
}
